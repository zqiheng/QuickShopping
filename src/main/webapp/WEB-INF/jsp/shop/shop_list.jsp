...
<div>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 店铺管理 <span
            class="c-gray en">&gt;</span> 店铺列表<a class="btn btn-success radius r"
            ...
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <c:forEach items="${shop}" var="shop">
                    <tr class="text-c va-m">
                        ...
                        <td>${shop.city }</td>
                        <td>${shop.county }</td>
                        <td class="text-l">${shop.detailAddress }</td>
                        <td>${shop.longitude }</td>
                        <td>${shop.latitude }</td>

                        <td class="td-manage">
                            <a style="text-decoration:none" class="ml-5" onclick="shop_edit('编辑','/web/shop/edit_shop_info?id='+${shop.id},'4','','510')"
